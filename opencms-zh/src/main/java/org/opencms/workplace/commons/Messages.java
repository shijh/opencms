...
public final class Messages extends A_CmsMessageBundle {
	...
	/** Message constant for key in the resource bundle. */
    public static final String GUI_PREF_TREE_LABEL_SELECTOR_0 = "GUI_PREF_TREE_LABEL_SELECTOR_0";
    /** Message constant for key in the resource bundle. */
    public static final String GUI_PREF_TREE_LABEL_NAME_0 = "GUI_PREF_TREE_LABEL_NAME_0";
    /** Message constant for key in the resource bundle. */
    public static final String GUI_PREF_TREE_LABEL_TITLE_0 = "GUI_PREF_TREE_LABEL_TITLE_0";
    /** Message constant for key in the resource bundle. */
    public static final String GUI_PREF_TREE_SORT_SELECTOR_0 = "GUI_PREF_TREE_SORT_SELECTOR_0";
    /** Message constant for key in the resource bundle. */
    public static final String GUI_PREF_TREE_SORT_NAME_0 = "GUI_PREF_TREE_SORT_NAME_0";
    /** Message constant for key in the resource bundle. */
    public static final String GUI_PREF_TREE_SORT_TITLE_0 = "GUI_PREF_TREE_SORT_TITLE_0";
    /** Message constant for key in the resource bundle. */
