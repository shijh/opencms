...
public class CmsDefaultUserSettings extends CmsUserSettings {
    ...
    public static final String[] TREE_SORTS = {"name","title","size","time"};
    /** Parameter for tree label name.*/
    private static final int TREELABEL_NAME = 0;
    /** Parameter for tree sort name.*/
    private static final int TREESORT_NAME = 0;
    
    /**
     * Returns a string representation of the explorer tree label.<p>
     * 
     * @return string representation of the explorer tree label
     */
    public String getExplorerTreeLabelString() {

        return TREE_LABELS[getExplorerTreeLabel()];
    }
     ...
     */
    public void setExplorerTreeLabel(String treelabel) {

        try {
            setExplorerTreeLabel(Integer.parseInt(treelabel));
        } catch (Throwable t) {
    ...
    /**
     * Returns a string representation of the explorer tree sort.<p>
     * 
     * @return string representation of the explorer tree sort
     */
    public String getExplorerTreeSortString() {

        return TREE_SORTS[getExplorerTreeSort()];
    }
     ...
     * @param buttonstyle the style of the explorer workplace buttons of the user 
     */
    public void setExplorerTreeSort(String treeSort) {

        try {
            setExplorerTreeSort(Integer.parseInt(treeSort));
        } catch (Throwable t) {
            // ignore this exception
        }
    }
