...
public class CmsWorkplaceConfiguration extends A_CmsXmlConfiguration {
    ...
    /** The name of the explorer tree label node. added by Shi Jinghai, huaruhai@hotmail.com 2014-4-16*/
    public static final String N_TREELABEL = "treelabel";

    /** The name of the explorer sort label node. added by Shi Jinghai, huaruhai@hotmail.com 2014-4-16*/
    ...
    public Element generateXml(Element parent) {
        ...
        // add the <treelabel> node, added by Shi Jinghai, huaruhai@hotmail.com 2014-4-16
        ...
        // add the <treesort> node, added by Shi Jinghai, huaruhai@hotmail.com 2014-4-16
