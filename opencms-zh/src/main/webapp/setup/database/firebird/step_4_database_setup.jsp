...
<table border="0" cellpadding="2" cellspacing="0">
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="2"><input type="checkbox" name="createTables" value="true" checked="true"> 创建数据库表 
		</td>
...
<br><br><b>注意：</b>你应该用参数 page_size 16KB 来创建数据库。 
<%= Bean.getHtmlPart("C_HELP_END") %>
