...
<br><br><b>注意：</b>你应该在Sybase配置文件"Lock Manager"下设置"lock scheme"为"datarows"。或者你可以修改setup/database/sybase/create_tables.sql脚本，用"datarows"覆盖缺省的锁。
<%= Bean.getHtmlPart("C_HELP_END") %>
